...
HD_PWD='C:/Final_Year_Project/Architecture/BCI_SOC/vhdl/xilinxprj/BCI_SOC.runs/version3_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log version3_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source version3_xbar_0.tcl
