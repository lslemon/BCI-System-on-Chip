...
################################################################
# This is a generated script based on design: bd_4e23
#
...
proc create_hier_cell_s11_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000000020000000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC000_ROUTE {0b000000000010} \
   CONFIG.SSC001_ROUTE {0b000000000001} \
   CONFIG.SSC002_ROUTE {0b000000000100} \
   CONFIG.SSC003_ROUTE {0b000000000000} \
   CONFIG.SSC004_ROUTE {0b000000000000} \
   CONFIG.SSC005_ROUTE {0b000000010000} \
   CONFIG.SSC006_ROUTE {0b000000001000} \
   CONFIG.SSC007_ROUTE {0b000000100000} \
   CONFIG.SSC008_ROUTE {0b000000000000} \
   CONFIG.SSC009_ROUTE {0b000000000000} \
   CONFIG.SSC010_ROUTE {0b000001000000} \
   CONFIG.SSC011_ROUTE {0b000010000000} \
   CONFIG.SSC012_ROUTE {0b000100000000} \
   CONFIG.SSC013_ROUTE {0b001000000000} \
   CONFIG.SSC014_ROUTE {0b000000000000} \
   CONFIG.SSC015_ROUTE {0b100000000000} \
   CONFIG.SSC016_ROUTE {0b010000000000} \
   CONFIG.SSC017_ROUTE {0b000000000000} \
   CONFIG.SSC018_ROUTE {0b000000000000} \
   CONFIG.SSC019_ROUTE {0b000000000000} \
   CONFIG.SSC020_ROUTE {0b000000000000} \
   CONFIG.SSC021_ROUTE {0b000000000000} \
   CONFIG.SSC022_ROUTE {0b000000000000} \
   CONFIG.SSC023_ROUTE {0b000000000000} \
   CONFIG.SSC024_ROUTE {0b000000000000} \
   CONFIG.SSC025_ROUTE {0b000000000000} \
   CONFIG.SSC026_ROUTE {0b000000000000} \
   CONFIG.SSC027_ROUTE {0b000000000000} \
   CONFIG.SSC028_ROUTE {0b000000000000} \
   CONFIG.SSC029_ROUTE {0b000000000000} \
   CONFIG.SSC030_ROUTE {0b000000000000} \
   CONFIG.SSC031_ROUTE {0b000000000000} \
   CONFIG.SSC_ROUTE_WIDTH {12} \
   CONFIG.S_ID_WIDTH {5} \
   CONFIG.WDATA_WIDTH {64} \
 ] $m00_exit
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins S08_ARESETN] [get_bd_pins S09_ARESETN] [get_bd_pins S10_ARESETN] [get_bd_pins S11_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:S00_AXI:S01_AXI:S02_AXI:S03_AXI:S04_AXI:S05_AXI:S06_AXI:S07_AXI:S08_AXI:S09_AXI:S10_AXI:S11_AXI} \
 ] $aclk
  ...
  connect_bd_intf_net -intf_net S_SC_AR_9 [get_bd_intf_pins m00_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M00_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_9 [get_bd_intf_pins m00_nodes/S_SC_R] [get_bd_intf_pins m00_sc2axi/M_SC_R]
