...
HD_PWD='C:/Final_Year_Project/Architecture/BCI_SOC/vhdl/xilinxprj/BCI_SOC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log version3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source version3_wrapper.tcl -notrace
