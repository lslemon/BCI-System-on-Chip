...
################################################################
# This is a generated script based on design: bd_6c86
#
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC016_ROUTE {0b0000000010000} \
   CONFIG.SSC017_ROUTE {0b0000000001000} \
   CONFIG.SSC018_ROUTE {0b0000000100000} \
   CONFIG.SSC019_ROUTE {0b0000000000010} \
   CONFIG.SSC020_ROUTE {0b0000000000001} \
   CONFIG.SSC021_ROUTE {0b0000000000100} \
