...
HD_PWD='C:/Final_Year_Project/Architecture/BCI_SOC/vhdl/xilinxprj/BCI_SOC.runs/version1_RELOAD_DMA_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log version1_RELOAD_DMA_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source version1_RELOAD_DMA_3.tcl
