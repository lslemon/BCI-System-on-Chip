...
HD_PWD='C:/Final_Year_Project/Architecture/BCI_SOC/vhdl/xilinxprj/BCI_SOC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log version3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source version3_wrapper.tcl
