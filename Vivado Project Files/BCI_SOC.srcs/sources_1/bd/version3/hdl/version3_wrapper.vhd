...
--Date        : Wed Apr 29 18:21:20 2020
--Host        : LAPTOP-H2S94EA8 running 64-bit major release  (build 9200)
--Command     : generate_target version3_wrapper.bd
...
end version3_wrapper;

architecture STRUCTURE of version3_wrapper is
  component version3 is
  port (
    FIXED_IO_mio : inout STD_LOGIC_VECTOR ( 53 downto 0 );
    FIXED_IO_ddr_vrn : inout STD_LOGIC;
    FIXED_IO_ddr_vrp : inout STD_LOGIC;
