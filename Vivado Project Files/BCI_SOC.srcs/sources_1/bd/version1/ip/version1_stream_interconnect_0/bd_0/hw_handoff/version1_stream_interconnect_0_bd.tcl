...
################################################################
# This is a generated script based on design: bd_8ee2
#
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC000_ROUTE {0b0000000000000010} \
   CONFIG.SSC001_ROUTE {0b0000000000000001} \
   CONFIG.SSC002_ROUTE {0b0000000000000000} \
   CONFIG.SSC003_ROUTE {0b0000000000001000} \
   CONFIG.SSC004_ROUTE {0b0000000000000100} \
   CONFIG.SSC005_ROUTE {0b0000000000010000} \
   CONFIG.SSC006_ROUTE {0b0000000000000000} \
   CONFIG.SSC007_ROUTE {0b0000000000000000} \
   CONFIG.SSC008_ROUTE {0b0000000000100000} \
   CONFIG.SSC009_ROUTE {0b0000000010000000} \
   CONFIG.SSC010_ROUTE {0b0000000001000000} \
   CONFIG.SSC011_ROUTE {0b0000000000000000} \
   CONFIG.SSC012_ROUTE {0b0000000000000000} \
   CONFIG.SSC013_ROUTE {0b0000001000000000} \
   CONFIG.SSC014_ROUTE {0b0000000100000000} \
   CONFIG.SSC015_ROUTE {0b0000100000000000} \
   CONFIG.SSC016_ROUTE {0b0000010000000000} \
   CONFIG.SSC017_ROUTE {0b0010000000000000} \
   CONFIG.SSC018_ROUTE {0b0001000000000000} \
   CONFIG.SSC019_ROUTE {0b1000000000000000} \
   CONFIG.SSC020_ROUTE {0b0100000000000000} \
